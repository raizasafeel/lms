...
/**
 * Twelve rows fit; row thirteen is reached by scrolling. The region has to be a
 * definite size for the column header to pin against and for the panel below to
 * stay put as rows arrive.
 */

// SettingsLayout is told `flush` for the same reason: the region begins at the
// body's own top edge, and padding above it would push the twelfth row past
// the bottom of a body that no longer scrolls to compensate.

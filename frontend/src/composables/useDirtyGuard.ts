...
// Guard a detail form against the state it loaded with. Re-baseline only when a replaced
// doc was still clean (idb seed / cache hit / reload); a dirty prev keeps its baseline.
